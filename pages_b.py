...
<section id="apply">
  <div class="wrap split">
    ...
    <form class="form-card reveal" data-formspree>
      ...
      <button class="btn btn-amber" type="submit">Send application</button>
...
<section>
  <div class="wrap split">
    ...
    <form class="form-card reveal" id="enroll" data-formspree>
      ...
      <input type="text" name="_gotcha" class="hp" tabindex="-1" autocomplete="off" aria-hidden="true" />
      <button class="btn btn-amber" type="submit">Apply now</button>
      <p class="form-msg" role="status" aria-live="polite" style="display:none;margin-top:.9rem;font-size:.85rem;font-weight:600"></p>
    </form>
  </div>
</section>
...
<section>
  <div class="wrap">
    ...
    <p style="text-align:center;margin-top:2.5rem;color:var(--ink-soft)">Still curious? <a href="contact.html" class="link-arrow" style="display:inline-flex">Ask us directly</a></p>
  </div>
</section>
"""
...
<section>
  <div class="wrap prose">
    ...
    <p style="margin-top:1.5rem"><a href="contact.html" class="link-arrow">Questions? Contact us</a></p>
  </div>
</section>
"""
