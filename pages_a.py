...
<section>
  <div class="wrap">
    <div class="grid-3">
      ...
      <article class="card reveal"><div class="ph mint">🧮</div><div class="card-body"><span class="cat">Tool</span><h3>Brewing Calculators</h3><p>ABV, attenuation and recipe math — free tools to check your numbers before you brew.</p><div class="foot"><a href="https://ankurnapa.github.io/indian-brewing-calculator/" class="link-arrow">Open the calculator</a></div></div></article>
      <article class="card reveal"><div class="ph amber">👃</div><div class="card-body"><span class="cat">Tool</span><h3>Off-Flavour Guide</h3><p>Diacetyl, DMS, oxidation, phenols — learn to name what your palate is telling you.</p><div class="foot"><a href="courses.html" class="link-arrow">Train your palate</a></div></div></article>
      <article class="card reveal"><div class="ph">🎧</div><div class="card-body"><span class="cat">Listen</span><h3>Blog &amp; Podcasts</h3><p>Conversations with brewers, founders and sensory pros on the craft and business of beer.</p><div class="foot"><a href="blog.html" class="link-arrow">Read &amp; listen</a></div></div></article>
    </div>
  </div>
</section>
